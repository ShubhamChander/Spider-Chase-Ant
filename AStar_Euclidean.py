...
class AStar_Euclidean():
	...
	def calcHValue(spiderLocCurr, antLoc):
		...
		HValue = math.sqrt(((x1-x2)**2) + ((y1-y2)**2))
		return HValue
		
	
	def applyEuclideanLogic(self,spiderLoc,antLoc):
		...
		while True:
			...
			for i in range(len(possMoves)):
				...
				FValue = AStar_Euclidean.calcFValue(depth,EuclideanDist_H)
